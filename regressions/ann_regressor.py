...
class ANNRegressor(BaseRegressor):
    ...
    def train_and_evaluate(self):
        ...
        results_df, results_path = self.save_results(
            mse=mse, rmse=rmse, mae=mae, r2=r2, r=r, top_features=top_features, model_type="ann"
        )

        # Modular residual plots using base
        self.plot_residuals(y_test, y_pred_test, X_test, top_features, "test", "ann")
        ...
        self.plot_residuals(y_train_full, y_pred_train, X_train_full, top_features, "train", "ann")
